...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <table>
                    <tr>
                        ...
                        <td class="delte-input-guest">
                            <input id="Text1" type="text" runat="server" autofocus="autofocus" placeholder="Please enter your itinerary's ID here that you want to edit..."/>
                        </td>
    ...
    <td class="right-guest-td">
        <input id="Text2" type="text" runat="server" placeholder="Please enter your itinerary item's name here..."/>
    </td>
