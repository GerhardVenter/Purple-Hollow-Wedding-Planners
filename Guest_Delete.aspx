                ...
                <table>
                    <tr>
                        ...
                        <td class="delte-input-guest">
                            <input id="Text1" type="text" runat="server" autofocus="autofocus"  placeholder="Please enter your guest's ID here that you want to delete..."/>
                        </td>

                        <td class="btnRemove-guest">
                            <asp:Button ID="btnRemoveGUest" runat="server" Text="Remove Guest" CssClass="giDelete-btn" OnClick="btnRemoveGUest_Click" OnClientClick="return confirm('Are you sure you want to delete this guest?');"/>
                        </td>
